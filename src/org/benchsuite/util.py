...
def set_output_verbosity(verbosity):
    global __output_verbosity
    __output_verbosity = verbosity

def print_message(msg, verbosity=0):
    if __output_stream and verbosity <= __output_verbosity:
        __output_stream.write(str(msg) + '\n')
