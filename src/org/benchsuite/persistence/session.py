...
class SessionStorageManager:
    ...
    def load(self):
        try:
            ...
            print_message('Benchmarking Sessions loaded from ' + self.storage_file, verbosity=2)
    ...
    def store(self):
        ...
        print_message('Benchmarking Sessions stored to ' + self.storage_file, verbosity=2)
